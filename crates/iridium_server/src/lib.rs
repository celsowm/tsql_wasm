...
use iridium_core::{SessionManager, SqlAnalyzer, StatementExecutor};

pub use server::TdsServer;

pub trait ServerDatabase: SessionManager + StatementExecutor + SqlAnalyzer + Send + Sync {}

impl<T> ServerDatabase for T where T: SessionManager + StatementExecutor + SqlAnalyzer + Send + Sync {}
