...
fn test_window_aggregates() {
    ...
    assert_eq!(r.rows.len(), 4);
    assert_eq!(r.rows[0][2], Value::Decimal(150000000, 6)); // 150.000000
    assert_eq!(r.rows[1][2], Value::Decimal(150000000, 6));
    assert_eq!(r.rows[2][2], Value::Decimal(200000000, 6)); // 200.000000
    assert_eq!(r.rows[3][2], Value::Decimal(200000000, 6));
}
