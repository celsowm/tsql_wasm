...
| String built-ins | compatible subset | Common functions present and tested; STRING_ESCAPE now supports JSON, HTML, XML, and CSV escape types | `README.md`, `crates/iridium_core/tests/new_string_functions.rs`, `crates/iridium_core/tests/sqlserver_strings.rs` |
| Math built-ins | compatible subset | Good coverage, still not a claim of exact parity | `README.md`, `crates/iridium_core/tests/new_math_functions.rs`, `crates/iridium_core/tests/sqlserver_math.rs` |
| Date/time built-ins | compatible subset | Common functions are present and tested | `README.md`, `crates/iridium_core/tests/sqlserver_dates.rs` |
| Metadata / system built-ins | compatible subset | Important helpers exist, but many SQL Server properties and system functions remain incomplete | `crates/iridium_core/tests/new_system_functions.rs`, `crates/iridium_core/src/executor/scalar/system/*` |
